...
function AboutSection(){
    return(
        <>
            <div className="bg-white w-screen h-26em flex items-center justify-center mt-10 my-20">
                <div className='flex md:flex-row flex-col md:justify-between items-center justify-center lg:mx-20 md:mx-12 md:py-20'>
                    ...
                    <div className="flex flex-col 2xl:pr-28 md:pr-10 text-center lg:text-lg text-sm" style={{ fontFamily: "'Comic Neue', cursive" }} >
