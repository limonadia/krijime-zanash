...
function CustomerReviews(){
    ...
    return(
        <>
        <div className="customer-div bg-white w-screen py-40 justify-center content-center flex" style={{ fontFamily: "'Comic Neue', cursive" }}>
            <div className="flex flex-col  w-9/12">
            <h1 className="md:text-4xl text-2xl" style={{color: '#b546ab'}}>What Our Customers Say</h1>
